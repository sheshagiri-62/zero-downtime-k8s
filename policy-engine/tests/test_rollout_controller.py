...
def test_promote(mock_subprocess):
    ...
    mock_subprocess.assert_called_once_with(["kubectl", "argo", "rollouts", "promote", "myapp", "-n", "zero-downtime"], capture_output=True, text=True)
...
def test_abort(mock_subprocess):
    ...
    mock_subprocess.assert_called_once_with(["kubectl", "argo", "rollouts", "abort", "myapp", "-n", "zero-downtime"], capture_output=True, text=True)
